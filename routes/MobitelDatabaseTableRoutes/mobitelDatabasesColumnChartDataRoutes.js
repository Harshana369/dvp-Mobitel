...
//---------------------------------------------------------------------------------------------------------------------------
//--------------------- Functions for Getting HandOver Data to the Front End of Mobitel Project Databases Area Graph----------------------
//---------------------------------------------------------------------------------------------------------------------------

function getHandOverdataToTheMonth(posts) {
  var handOverData = [];
  var installedData = [];
  var holdData = [];
  var patData = [];
